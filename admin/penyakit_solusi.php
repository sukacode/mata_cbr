...
<table id="tabel" width="100%" cellpadding="3" cellspacing="0" border="1" align="center">
  <tr valign="top" bgcolor="#CCCC99">
    ...
    <td width="103"><strong>Kode Penyakit </strong></td>
    <td width="134"><strong>Nama Penyakit</strong></td>
	<td width="362"><strong>Definisi</strong></td>
    <td width="268"><strong>Solusi</strong></td>
    <td width="50"><strong>Edit</strong></td>
    <td width="59"><strong>Hapus</strong></td>
  </tr>
  <?php
	include "../koneksi.php";
  ...
  <tr valign="baseline">
    ...
    <td><p class="text"><?php $str=$data['solusi'];
	$teks=substr($str,0,150);
	echo $str; ?></p></td>
