...
<body>
<h2>Data Rule Case Based Reasoning (CBR)</h2><hr>
<div class="konten">
<?php
include "../koneksi.php";
...
<table width="100%" border="0" cellpadding="4" cellspacing="1" bordercolor="#F0F0F0" >
  ...
  <tr bgcolor="#FFFFFF" bordercolor="#333333">
	...
	while ($row2=mysql_fetch_array($query2)){
		...
		echo "<td width='20'><a title='Edit Relasi' href='haladmin.php?top=edit_relasi.php&id_relasi=$row2[id_relasi]&kd_penyakit=$row2[kd_penyakit]&kd_gejala=$row2[kd_gejala]'>Edit</a></td>";
